    ...
    <div class="col-md-12">
        <div class="panel panel-default">
            ...
            @if(Session::has('message'))
                    ...
                    @endif
                <form class="form-horizantal" enctype="multipart/form-data" wire:submit.prevent="updateproduct">
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    <select class="form-control" wire:model="stock_status">
                                        ...
                                        <option value="outofStock">out ofStock</option>
                                    </select>
                                </div>
                    </div>
                    ...
                    <div class="form-group">
                                ...
                                <div class="col-md-4">
                                    ...
                                    @else
                                    <img src="{{asset('assets/images/products')}}/{{$image}}" widht="120"/> 
                                    @endif
                                </div>
                    </div>
